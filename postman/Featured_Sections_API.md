...
```json
{
  ...
  "name_en": "Sandwich",
  "name_ar": "ساندويتش",
  "image_url": "http://domain.com/storage/modules/sandwich.png",
...
| image_url  | string  | Full image URL (resolved from the linked item)     |
...
```json
{
  "success": true,
  "data": [
    { "id": 1, "name_en": "Sandwich", "name_ar": "ساندويتش", "image": "modules/sandwich.png", "image_url": "http://..." },
    { "id": 2, "name_en": "Pizza", "name_ar": "بيتزا", "image": "modules/pizza.png", "image_url": "http://..." }
  ]
}
```
